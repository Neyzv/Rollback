...
namespace Rollback.Protocol.Types
{
    public record MountClientData
    {
        ...
        {
            byte flag1 = 0;
            flag1 = BigEndianBooleanByteWrapper.SetFlag(flag1, 0, sex);
            flag1 = BigEndianBooleanByteWrapper.SetFlag(flag1, 1, isRideable);
            flag1 = BigEndianBooleanByteWrapper.SetFlag(flag1, 2, isWild);
            flag1 = BigEndianBooleanByteWrapper.SetFlag(flag1, 3, isFecondationReady);
        ...
        public virtual void Deserialize(BigEndianReader reader)
        {
            ...
            sex = BigEndianBooleanByteWrapper.GetFlag(flag1, 0);
            isRideable = BigEndianBooleanByteWrapper.GetFlag(flag1, 1);
            isWild = BigEndianBooleanByteWrapper.GetFlag(flag1, 2);
            isFecondationReady = BigEndianBooleanByteWrapper.GetFlag(flag1, 3);
